...
Function startcgminer() {
  $process = "C:\Users\root\Desktop\startmine.bat"
  $basepath = "C:\users\root\desktop\cgminer-3.5.0-windows\logs\"
  ...
  Try {
    ...
    logdebug "Could not start new instance of cgminer. Exception:"+$_.Exception.Message
  }
}

#check if cgminer is already running, otherwise start it.
